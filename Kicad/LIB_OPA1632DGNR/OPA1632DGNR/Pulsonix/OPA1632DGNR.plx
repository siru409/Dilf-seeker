...
(library Library_1
	...
	(compDef "OPA1632DGNR" (originalName "OPA1632DGNR") (compHeader (numPins 9) (numParts 1) (refDesPrefix IC)
		...
		(compPin "7" (pinName "ENABLE") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "V-") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "VOUT-") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/OPA1632")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "OPA1632DGNR.stp")
		(attr "<STEP Offsets>" "X=0;Y=0;Z=0.62")
