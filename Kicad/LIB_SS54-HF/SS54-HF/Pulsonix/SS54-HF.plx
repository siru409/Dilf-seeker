...
(library Library_1
	...
	(patternDef "DIOM5025X220N" (originalName "DIOM5025X220N")
		...
		(layerContents (layerNumRef 28)
			(line (pt -2.475 1.25) (pt 2.475 1.25) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 2.475 1.25) (pt 2.475 -1.25) (width 0.025))
		)
		...
		(layerContents (layerNumRef 28)
			(line (pt -2.475 0.475) (pt -1.7 1.25) (width 0.025))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "SS54-HF" (originalName "SS54-HF") (compHeader (numPins 2) (numParts 1) (refDesPrefix D)
		...
		(attr "<Hyperlink>" "https://componentsearchengine.com/Datasheets/1/SS54-HF.pdf")
		(attr "<Component Height>" "2.2")
		(attr "<STEP Filename>" "SS54-HF.stp")
